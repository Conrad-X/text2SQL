...
class MSchema:
    ...
    def to_mschema(self, selected_tables: List = None, selected_columns: List = None,
        ...
        selected_tables: The default is None, which means all tables are selected.
        selected_columns: The default is None, which means all columns are selected in the format ['table_name.column_name'].
        """
        output = []
        ...
        # Add foreign key information, but do not display foreign keys when table_type is set to view
