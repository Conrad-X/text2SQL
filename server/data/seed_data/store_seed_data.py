...
def seed_db():
    ...
    try:
        ...
        customers = [
            models.Customer(customerno=4, customername='Alice Johnson', customeremail='alice@example.com'),
            models.Customer(customerno=5, customername='Bob Smith', customeremail='bob@example.com'),
            models.Customer(customerno=6, customername='Charlie Brown', customeremail='charlie@example.com'),
        ]
