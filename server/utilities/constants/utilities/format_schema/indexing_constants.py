"""
This module defines constants used for indexing and formatting schema information.

These constants are used to standardize keys and values across the application.
"""
...
TABLE_FOREIGN_KEY = "foreign_keys"
