...
class TestPrepareSampleDataset(unittest.TestCase):
    ...
    @patch('builtins.open', new_callable=mock_open, read_data='{"db_id": "db1", "question_id": "q1", "sql": "SELECT * FROM table"}')  # Mocking API key during test
