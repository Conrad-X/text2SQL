...
def evaluate_spider2sql(args):
    ...
    spider2sql_metadata = load_json_list_to_dict("./data/spider2/spider2-snow/test_data/spider2-snow.jsonl")
    ...
    for id in tqdm(eval_ids):
        ...
        if mode == "sql":
            ...
            if spider2sql_metadata[id]['db_id']=='GITHUB_REPOS':
